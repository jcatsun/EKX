...
\cf2 \strokec2 export\cf0 \strokec4  \cf2 \strokec2 class\cf0 \strokec4  \cf5 \strokec5 GeminiService\cf0 \strokec4  \{\
  \cf2 \strokec2 async\cf0 \strokec4  sendMessage(\
    ...
    \cf2 \strokec2 const\cf0 \strokec4  ai = \cf2 \strokec2 new\cf0 \strokec4  \cf5 \strokec5 GoogleGenAI\cf0 \strokec4 (\{ apiKey: process.env.\cf5 \strokec5 API_KEY\cf0 \strokec4  \});\
    ...
    \cf2 \strokec2 if\cf0 \strokec4  (image) \{\
      \cf2 \strokec2 const\cf0 \strokec4  mimeType = image.match(\cf7 \strokec7 /data:([^;]+);base64/\cf0 \strokec4 )?.[\cf8 \strokec8 1\cf0 \strokec4 ] || \cf6 \strokec6 'image/jpeg'\cf0 \strokec4 ;\
      \cf2 \strokec2 const\cf0 \strokec4  base64Data = image.split(\cf6 \strokec6 ','\cf0 \strokec4 )[\cf8 \strokec8 1\cf0 \strokec4 ] || image;\
      parts.push(\{\
        inlineData: \{\
          data: base64Data,\
          mimeType: mimeType\
...
\
    \cf2 \strokec2 try\cf0 \strokec4  \{\
      \cf2 \strokec2 const\cf0 \strokec4  response: \cf5 \strokec5 GenerateContentResponse\cf0 \strokec4  = \cf2 \strokec2 await\cf0 \strokec4  ai.models.generateContent(\{\
        model: modelName,\
        contents: [\
          ...history.slice(-\cf8 \strokec8 10\cf0 \strokec4 ).map(msg => (\{\
        ...
        config: \{\
          ...
          temperature: \cf8 \strokec8 0.7\cf0 \strokec4 ,\
        \}\
      \});\
\
